...
class Editor {
    ...
    get isAttachedQuillEditorToDOM() {
        var _a, _b;
        return (_b = (_a = this.quillElements) === null || _a === void 0 ? void 0 : _a.editorElement) === null || _b === void 0 ? void 0 : _b.isConnected;
    }
    ngAfterViewInit() {
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "15.2.2", ngImport: i0, type: Editor, decorators: [{
            type: Component,
...
EditorModule.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "15.2.2", ngImport: i0, type: EditorModule, deps: [], target: i0.ɵɵFactoryTarget.NgModule });
EditorModule.ɵmod = i0.ɵɵngDeclareNgModule({ minVersion: "14.0.0", version: "15.2.2", ngImport: i0, type: EditorModule, declarations: [Editor], imports: [CommonModule], exports: [Editor, SharedModule] });
EditorModule.ɵinj = i0.ɵɵngDeclareInjector({ minVersion: "12.0.0", version: "15.2.2", ngImport: i0, type: EditorModule, imports: [CommonModule, SharedModule] });
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "15.2.2", ngImport: i0, type: EditorModule, decorators: [{
            type: NgModule,
            args: [{
